...
(function (root, factory) {
    if (typeof exports === 'object') {
        ...
        if (define.amd) 
            // AMD
            define([], function (b) {
                return (root.couchapi = factory(jQuery));
            });
        else
            //[bootstrapjs](//github.com/michieljoris/bootstrapjs)
            define({inject: [], factory: factory(jQuery) });
      
    } else {
        // Global variable
        root.couchapi = factory(jQuery);
    }
})(this, function($) { 
    // (function($) {
    /** @lends $.couch */
    ...
    var inArray = $.inArray;
    //Last dependencies on jQuery below here are $.ajax and $.browser.msie
