  ...
  if (typeof module != 'undefined' && module &&
    ...
    api._couch = {
        ...
        userDb : function(callback) {
            api._couch.session({
                success : function(resp) {
                    var userDb = api._couch.db(resp.info.authentication_db);
                    callback(userDb);
                },
        ...
        signup: function(user_doc, password, options) {      
            ...
            api._couch.userDb(function(db, status, error, reason) {
        ...
        //  * Deprecated. Use _replicator database.
        //  * @see <a href="http://techzone.couchbase.com/sites/default/files/
        ...
        replicate: function(repOpts, options) {
            this.db('_replicator').saveDoc(repOpts, options);
        }, 
...
// console.log('vouchdb_couch loaded') ;
