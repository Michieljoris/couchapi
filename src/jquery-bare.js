...
var
	...
	// Document location
	// ajaxLocation = location ? location.href : 'some location',
    
	ajaxLocation = typeof location !== 'undefined' ? location.href : 'some location',
...
// var ajax = module.exports.ajax;
// console.log(ajax);
// ajax("http://localhost:8080", {
//     complete: function(data) { console.log('hello', data); }
// });
